(function () {
    ...
    function a(t, e) {
      ...
      return (!n || !!E[n.trim()]) && (!k || !t.hasAttribute("nomodule")) && (!!k || n !== "module");
    }
    function c(t) {
      return a(t, "");
    }
    ...
    function m(t) {
      if (t instanceof Window) {
        ...
        return ["DOMContentLoaded", "readystatechange"];
      } else {
        return [];
      }
    }
    ...
    function g(t) {
      ...
      Array.prototype.forEach.call(document.querySelectorAll("[" + e + "]"), function (n) {
        ...
        Array.prototype.forEach.call(n.attributes, function (e) {
          if (/^on/.test(e.name) && typeof n[e.name] != "function") {
    ...
    var k = document.createElement("script").noModule !== undefined;
    var I = function () {
      var t = window;
      if (!t.__rocketLoaderEventCtor) {
    ...
    var D = function () {
      ...
      t.prototype.hasNonce = function (t) {
        return (t.getAttribute("type") || "").indexOf(this.nonce) === 0;
      };
    ...
    var j = function () {
      ...
      t.prototype.setupEventListenerProxy = function () {
        var t = this;
        (typeof EventTarget != "undefined" ? [EventTarget.prototype] : [Node.prototype, Window.prototype]).forEach(function (e) {
      ...
      t.prototype.proxyInlineHandler = function (t, e) {
        try {
          ...
          console.warn("encountered an error when accessing " + e + " handler:", o.message);
          return;
        }
      };
      return t;
    ...
    var M = function () {
      var t = window;
      if (!t.__rocketLoaderLoadProgressSimulator) {
    ...
    var W = function () {
      ...
      t.prototype.insertPreloadHints = function () {
        ...
        this.scriptStack.forEach(function (e) {
          if (a(e, t.settings.nonce)) {
            var n = i(e);
            var r = v() && e.hasAttribute("integrity");
            if (n && !r) {
      ...
      t.prototype.run = function () {
        ...
        while (this.scriptStack.hasItems) {
          var n = function () {
            ...
            if (o) {
              if (r.external && r.executable && !r.async) {
                u(o, function () {
                ...
                e.finalizeActivation(r);
                return;
              }
            } else {
              if (n) {
                n.flushWrittenContentAndDisable();
              }
              return "continue";
            }
          }();
      ...
      t.prototype.activateScript = function (t) {
        ...
        if (c) {
          ...
          e("Failed to create activatable copy of script \n" + n.outerHTML + "\n", "Script will not be executed.");
          return null;
        }
      };
      return t;
    }();
    var R = "data-cf-settings";
    var T = "|";
    var B = "data-cf-modified-";
    var U = undefined;
    (function () {
